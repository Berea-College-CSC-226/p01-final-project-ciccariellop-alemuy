...
```
    ...
    I chose the snake game to suggest to Yoseph because I played it a lot since I was younger, especially during COVID. The final project reflects the initial idea very well, with only minor deviations. I learned a lot from this process about coding, working on projects, and with different perspectives. The hardest part was definitely bringing myself to do the coding after breaking down the subtasks. After starting to code, it was much better. The momentum helped me continue. Next time, I may choose a different game with different constraints to challenge myself. Working with my partner went well overall. It was challenging because of our different schedules, priorities, and Yoseph injuring his hand. Despite all of this, I feel we were able to do our respective parts to make it work. 
```
